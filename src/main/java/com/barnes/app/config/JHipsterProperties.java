...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "mage@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "mage API";

        private String description = "mage API documentation";
